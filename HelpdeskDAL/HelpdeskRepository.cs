...
// This is a generic repository implementation for handling CRUD operations.
// It interacts with the database through the HelpdeskContext and provides methods for 
// retrieving, adding, updating, and deleting entities of any type.
// ============================================================================
...
public class HelpdeskRepository<T> : IRepository<T> where T : HelpdeskEntity
{
    ...
    public async Task<UpdateStatus> Update(T updatedEntity)
    {
        ...
        try
        {
            Console.WriteLine("Updated entity Id: " + updatedEntity.Id);
